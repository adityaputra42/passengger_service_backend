...
func (tx *Tx) init() {
	...
	tx.BookingPassenger = NewBookingPassengerClient(tx.config)
	...
	tx.Seats = NewSeatsClient(tx.config)
...
// applies a query, for example: Aircraft.QueryXXX(), the query will be executed

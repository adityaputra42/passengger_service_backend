...
func (_u *UserUpdate) AddBookingIDs(ids ...uuid.UUID) *UserUpdate {
...
func (_u *UserUpdate) RemoveBookingIDs(ids ...uuid.UUID) *UserUpdate {
...
// AddBookingIDs adds the "bookings" edge to the Booking entity by IDs.
func (_u *UserUpdateOne) AddBookingIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddBookingIDs(ids...)
	return _u
}
...
// RemoveBookingIDs removes the "bookings" edge to Booking entities by IDs.
func (_u *UserUpdateOne) RemoveBookingIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveBookingIDs(ids...)
	return _u
}
